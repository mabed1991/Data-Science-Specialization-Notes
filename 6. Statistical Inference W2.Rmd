...
```{r normalD, echo=FALSE, fig.height=4, fig.width=4, warning=FALSE}
###  
...
```{r cumCoin, fig.height=4, fig.width=4, warning=FALSE}
library(ggplot2)
...
```{r cumCoin10, fig.height=4, fig.width=4}
#Try for n=10.
coinPlot(10)
```


```{r cumCoin10000, fig.height=4, fig.width=4}
#Try for n=10000.
coinPlot(10000)
```
...
```{r waldFail, echo=FALSE, fig.height=3, fig.width=4}
...
```{r waldPass, echo=FALSE, fig.height=3, fig.width=4}
...
```{r agrestiCoullDemo, fig.height=3, fig.width=4}
n <- 20; pvals <- seq(.1, .9, by = .05); nosim <- 1000
coverage <- sapply(pvals, function(p){
...
```{r poisCoverage, echo=FALSE, fig.height=4, fig.width=4}
...
```{r poisCoverageImproved, echo=FALSE, fig.height=4, fig.width=4}
lambdavals <- seq(0.005, 0.10, by = .01); nosim <- 1000
t <- 1000
coverage <- sapply(lambdavals, function(lambda){
  lhats <- rpois(nosim, lambda = lambda * t) / t
